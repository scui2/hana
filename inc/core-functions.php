...
function hana_page_title() {	
	...
	elseif ( is_tag() ) {
		$tag_description = get_the_archive_description();
		if ( empty( $tag_description ) )				
			$title = sprintf( __( '<span class="pt-label">Tag: </span><span class="pt-name">%s</span>', 'hana' ), esc_attr( get_the_archive_title() ) );
		else
